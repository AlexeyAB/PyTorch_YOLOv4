...
def create(name, pretrained, channels, classes):
    ...
    try:
        ...
        if pretrained:
            ...
            url_name = 'https://github.com/AlexeyAB/PyTorch_YOLOv4/releases/download/models_24_07_2020_u5_m/' + ckpt
            print(url_name)
            dst_ckpt = './' + ckpt
...
def yolov4_pacsp_mish(pretrained=False, channels=3, classes=80):
    """YOLOv4-medium model from https://github.com/AlexeyAB/PyTorch_YOLOv4/releases/tag/models_24_07_2020_u5_m
